...
$BASE_MODEL  = "E:\stable-diffusion-webui\models\Stable-diffusion\meinamix_meinaV11.safetensors"
$OUT_DIR     = "F:\bot\data\lora\output"
$LOG_DIR     = "F:\bot\data\lora\logs"
$DATASET_CFG = "F:\bot\lora\dataset_config.toml"
$OUTPUT_NAME = "yuki_lora_v3_meina"

$timestamp = Get-Date -Format "yyyyMMdd_HHmmss"
$log_file  = "$LOG_DIR\train_v3_meina_$timestamp.log"

Write-Host "== Training V3 — MeinaMix V11 base =="
