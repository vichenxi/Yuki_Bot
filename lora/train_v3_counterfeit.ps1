...
$BASE_MODEL  = "E:\stable-diffusion-webui\models\Stable-diffusion\Counterfeit-V3.0_fix_fp16.safetensors"
$OUT_DIR     = "F:\bot\data\lora\output"
$LOG_DIR     = "F:\bot\data\lora\logs"
$DATASET_CFG = "F:\bot\lora\dataset_config.toml"
$OUTPUT_NAME = "yuki_lora_v3_counterfeit"

$timestamp = Get-Date -Format "yyyyMMdd_HHmmss"
$log_file  = "$LOG_DIR\train_v3_counterfeit_$timestamp.log"

Write-Host "== Training V3 — CounterfeitV3 base =="
