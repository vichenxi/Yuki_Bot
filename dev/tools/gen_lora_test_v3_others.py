"""
Gen LoRA v3 — MeinaMix / CounterfeitV3 / AnythingV5.
Same bust13 prompt + compel. clip_skip=2 for Meina/Counterfeit, 1 for Anything.
"""
import torch
...
MODELS = [
    {
        ...
        "lora":      r"F:\bot\data\lora\output\yuki_lora_v3_meina.safetensors",
        "clip_skip": 2,
        "outdir":    Path(r"F:\bot\data\lora\test_images_v3_meina_bust"),
    },
    {
        "tag":       "counterfeit",
        ...
        "clip_skip": 2,
        "outdir":    Path(r"F:\bot\data\lora\test_images_v3_counterfeit_bust"),
    },
    {
        "tag":       "anything",
        ...
        "clip_skip": 1,
        "outdir":    Path(r"F:\bot\data\lora\test_images_v3_anything_bust"),
    },
]
