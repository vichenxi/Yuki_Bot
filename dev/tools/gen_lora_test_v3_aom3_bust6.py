"""
Gen LoRA v3 AOM3 — bust, aggressive eye size reduction.
narrow eyes weighted + thin/hooded terms; big eyes strongly negated.
"""
import torch
...
OUTDIR = Path(r"F:\bot\data\lora\test_images_v3_aom3_bust6")
...
NEG = (
    ...
    "(big eyes:1.5), (large eyes:1.5), wide eyes, doe eyes, wide-eyed, round eyes"
)

BUST = (
    "yukixue, 1girl, solo, mature female, adult, "
    "black hair, very long straight black hair, center part, "
    "grey eyes, (narrow eyes:1.5), thin eyes, hooded eyes, half-closed eyes, pale skin, "
...
TESTS = [
    ...
    {"name": "02_scale07_seed7",   "lora_scale": 0.7, "seed": 7},
    {"name": "03_scale06_seed42",  "lora_scale": 0.6, "seed": 42},
    {"name": "04_scale06_seed7",   "lora_scale": 0.6, "seed": 7},
    {"name": "05_scale05_seed42",  "lora_scale": 0.5, "seed": 42},
