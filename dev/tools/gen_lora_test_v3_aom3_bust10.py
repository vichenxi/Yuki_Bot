"""
Gen LoRA v3 AOM3 — bust10.
Use compel for long prompt encoding — no 77-token limit.
Full eye control + full composition tags, both land.
"""
import torch
...
OUTDIR = Path(r"F:\bot\data\lora\test_images_v3_aom3_bust10")
