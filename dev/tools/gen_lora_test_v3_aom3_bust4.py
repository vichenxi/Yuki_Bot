"""
Gen LoRA v3 AOM3 — bust, remove eye descriptors, use overall demeanor tags instead.
"""
import torch
...
OUTDIR = Path(r"F:\bot\data\lora\test_images_v3_aom3_bust4")
...
TESTS = [
    ...
    {"name": "07_scale07_seed123", "lora_scale": 0.7, "cfg": 7.5, "seed": 123},
    {"name": "08_scale06_seed123", "lora_scale": 0.6, "cfg": 7.5, "seed": 123},
]
