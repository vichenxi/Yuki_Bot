"""
Gen LoRA v3 AOM3 — bust8.
Keep bust6 eye control intact, drop turtleneck so framing tags land within 77 tokens.
4 good seeds from bust6: 01/06/07/08.
"""
import torch
...
OUTDIR = Path(r"F:\bot\data\lora\test_images_v3_aom3_bust8")
