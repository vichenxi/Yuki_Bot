"""
Gen LoRA v3 AOM3 — bust11.
Remove color descriptors from neg, remove black hair from pos — let LoRA carry the color.
"""
import torch
...
OUTDIR = Path(r"F:\bot\data\lora\test_images_v3_aom3_bust11")
