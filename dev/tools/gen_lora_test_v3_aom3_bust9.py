"""
Gen LoRA v3 AOM3 — bust9.
Trim 7 tokens to fit <77: drop hooded/half-closed eyes + indifferent + composed.
Keep (narrow eyes:1.5) + thin eyes as core eye control.
"""
import torch
...
OUTDIR = Path(r"F:\bot\data\lora\test_images_v3_aom3_bust9")
...
BUST = (
    ...
    "grey eyes, (narrow eyes:1.5), thin eyes, pale skin, "
